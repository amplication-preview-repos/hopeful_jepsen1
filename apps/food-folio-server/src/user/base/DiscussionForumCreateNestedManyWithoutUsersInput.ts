...
@InputType()
class DiscussionForumCreateNestedManyWithoutUsersInput {
...
export { DiscussionForumCreateNestedManyWithoutUsersInput as DiscussionForumCreateNestedManyWithoutUsersInput };
